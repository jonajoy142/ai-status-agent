...
- Tool calling
- MCP-ready tool descriptors and registry
- Retrieval-augmented generation architecture
- Vector-search-ready retrieval layer
- Structured report outputs with Pydantic
- Source attribution
- Lightweight observability with in-memory traces and OpenTelemetry span hooks
- Public-demo-safe deployment defaults
- Polished Next.js SaaS UI
...
5. Open Evaluations to show quality checks.
6. Open Settings to explain provider configuration and MCP-ready tools.
...
## Expansion Path After Phase 1

- Real Jira, Slack, GitHub, Linear, Confluence, and Notion tools
- Qdrant Cloud vector backend
- Hosted Langfuse or OpenTelemetry traces
- Evaluation datasets and regression scoring
- Persistent run history
- Auth and multi-project support
