...
export default function RiskCenterPage() {
  ...
  const riskRows = data?.risks || fallbackRisks.map((risk, i) => ({ id: `risk-${i}`, title: risk.title, level: risk.level.toLowerCase() as "low" | "medium" | "high", owner: risk.owner, business_impact: risk.impact, recommended_action: risk.action }));
